...
export var FormLink = function (_a) {
    var label = _a.label, linkText = _a.linkText, name = _a.name, to = _a.to, className = _a.className, inlineLabel = _a.inlineLabel, _b = _a.labelCol, labelCol = _b === void 0 ? 4 : _b, _c = _a.inputCol, inputCol = _c === void 0 ? 8 : _c;
